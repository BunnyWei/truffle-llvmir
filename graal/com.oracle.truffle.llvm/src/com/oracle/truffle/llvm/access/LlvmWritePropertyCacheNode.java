 ...
 */
public abstract class LlvmWritePropertyCacheNode extends Node {

    public static LlvmWritePropertyCacheNode create(String propertyName) {
    ...
    protected abstract static class SLWritePropertyCacheChainNode extends LlvmWritePropertyCacheNode {
        protected final Shape oldShape;
        protected final Shape newShape;
        @Child protected LlvmWritePropertyCacheNode next;

        public SLWritePropertyCacheChainNode(Shape oldShape, Shape newShape, LlvmWritePropertyCacheNode next) {
    ...
    protected static class SLWriteObjectPropertyNode extends SLWritePropertyCacheChainNode {
        ...
        protected SLWriteObjectPropertyNode(Shape oldShape, Shape newShape, Location location, LlvmWritePropertyCacheNode next) {
    ...
    protected static class SLWriteBooleanPropertyNode extends SLWritePropertyCacheChainNode {
        ...
        protected SLWriteBooleanPropertyNode(Shape oldShape, Shape newShape, BooleanLocation location, LlvmWritePropertyCacheNode next) {
            super(oldShape, newShape, next);
            this.location = location;
        }
    ...
    protected static class SLWriteLongPropertyNode extends SLWritePropertyCacheChainNode {
        ...
        protected SLWriteLongPropertyNode(Shape oldShape, Shape newShape, LongLocation location, LlvmWritePropertyCacheNode next) {
            super(oldShape, newShape, next);
            this.location = location;
        }
    ...
    protected static class SLUninitializedWritePropertyNode extends LlvmWritePropertyCacheNode {
        ...
        public void executeObject(DynamicObject receiver, Object value) {
            ...
            final LlvmWritePropertyCacheNode resolvedNode;
        ...
        private LlvmWritePropertyCacheNode getTopNode() {
            LlvmWritePropertyCacheNode top = this;
            while (top.getParent() instanceof LlvmWritePropertyCacheNode) {
                top = (LlvmWritePropertyCacheNode) top.getParent();
            }
            return top;
        }
