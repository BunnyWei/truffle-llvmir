 ...
 * <p>
 * The {@link #callTarget} can be {@code null}. To ensure that only one {@link LlvmFunction} instance
 * per name exists, the {@link LlvmFunctionRegistry} creates an instance also when performing name
...
public final class LlvmFunction {
    ...
    protected LlvmFunction(String name) {
        this.name = name;
