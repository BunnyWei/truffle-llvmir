 ...
 * <p>
 * Block redefinition is expected to be rare, therefore optimized call nodes want to speculate that
 * the call target is stable. This is possible with the help of a Truffle {@link Assumption}: a call
 * returned by {@link #getCallTargetStable()} is valid.
 * <p>
 * The {@link #callTarget} can be {@code null}. To ensure that only one {@link LlvmBlock} instance
 * lookup. A function that has been looked up, i.e., used, but not defined, has no call target.
 */
public final class LlvmBlock {
