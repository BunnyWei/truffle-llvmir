...
/**
 * A {@link LlvmExpressionNode} that represents a parenthesized expression; it simply returns the
...
public class LlvmParenExpressionNode extends LlvmExpressionNode {

    private final LlvmExpressionNode expression;

    public LlvmParenExpressionNode(SourceSection src, LlvmExpressionNode expression) {
        super(src);
