...
public final class LlvmFunctionLiteralNode extends LlvmExpressionNode {

    private final LlvmFunction value;

    public LlvmFunctionLiteralNode(SourceSection src, LlvmFunction value) {
        super(src);
        this.value = value;
    }
