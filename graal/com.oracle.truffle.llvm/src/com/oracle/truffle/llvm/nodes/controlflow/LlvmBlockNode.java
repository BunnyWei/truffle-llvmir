...
public final class LlvmBlockNode extends LlvmStatementNode {
    /**
    ...
    public LlvmBlockNode(SourceSection src, LlvmStatementNode... bodyNodes) {
        super(src);
     ...
     * the loop during compilation. This allows the {@link LlvmStatementNode#executeVoid} method of
    ...
    public void executeVoid(VirtualFrame frame) {
        ...
        for (LlvmStatementNode statement : bodyNodes) {
