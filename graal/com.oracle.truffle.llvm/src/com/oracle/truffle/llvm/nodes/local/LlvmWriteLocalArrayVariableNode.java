package com.oracle.truffle.llvm.nodes.local;
...
@NodeChild("valueArrayNode")
@NodeField(name = "slot", type = FrameSlot.class)
public abstract class LlvmWriteLocalArrayVariableNode extends LlvmExpressionNode {

    public LlvmWriteLocalArrayVariableNode(SourceSection src) {
        super(src);
    }
    ...
    protected List writeLong(VirtualFrame frame, List value) {
        int[] result = (int[]) value.get(0);
        frame.setObject(getSlot(), result[(int) value.get(1)]);
        return value;
    }
