...
public final class LlvmFunctionBodyNode extends LlvmExpressionNode {
    ...
    public LlvmFunctionBodyNode(SourceSection src, LlvmStatementNode bodyNode) {
        super(src);
