...
/**
 * Exception thrown by the {@link LlvmBreakNode break statement} and caught by the
 ...
 */
public final class LlvmBreakException extends ControlFlowException {

    public static final LlvmBreakException SINGLETON = new LlvmBreakException();

    private static final long serialVersionUID = -91013036379258890L;

    /* Prevent instantiation from outside. */
    private LlvmBreakException() {
    }
}
