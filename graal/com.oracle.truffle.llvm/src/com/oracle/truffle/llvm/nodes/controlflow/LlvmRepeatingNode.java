...
public final class LlvmRepeatingNode extends Node implements RepeatingNode {

    /**
     * The condition of the loop. This in a {@link LlvmExpressionNode} because we require a result
    ...
    /** Statement (or {@link LlvmBlockNode block}) executed as long as the condition is true. */
    @Child private LlvmStatementNode bodyNode;
    ...
    public LlvmRepeatingNode(SourceSection src, LlvmExpressionNode conditionNode, LlvmStatementNode bodyNode) {
        super(src);
