 ...
 * variables {@link LlvmNodeFactory#addFormalParameter in the method prologue}.
 */
public class LlvmReadArgumentNode extends LlvmExpressionNode {
    ...
    public LlvmReadArgumentNode(SourceSection src, int index) {
        super(src);
        this.index = index;
    }
