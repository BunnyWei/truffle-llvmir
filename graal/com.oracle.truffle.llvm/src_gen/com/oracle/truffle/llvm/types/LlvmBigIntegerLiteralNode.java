 ...
 * {@link LlvmLongLiteralNode}.
 */
@NodeInfo(shortName = "const")
public final class LlvmBigIntegerLiteralNode extends LlvmExpressionNode {

    private final BigInteger value;

    public LlvmBigIntegerLiteralNode(SourceSection src, BigInteger value) {
        super(src);
        this.value = value;
    }
