...
public class SLMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File file = new File("/Users/zhulixia/Desktop/test.txt");
        FileInputStream input = new FileInputStream(file);
        InputStreamReader inputstream = new InputStreamReader(input);
        BufferedReader reader = new BufferedReader(inputstream);
        // SLContext context = SLContextFactory.create(new BufferedReader(new
// InputStreamReader(System.in)), System.out);

        SLContext context = SLContextFactory.create(reader, System.out);
        Source source;
        if (args.length == 0) {
