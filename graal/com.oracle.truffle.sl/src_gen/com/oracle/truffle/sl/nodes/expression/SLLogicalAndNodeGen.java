...
public final class SLLogicalAndNodeGen extends SLLogicalAndNode {
    ...
    private SLLogicalAndNodeGen(SourceSection src, SLExpressionNode leftNode, SLExpressionNode rightNode) {
        super(src);
    ...
    public static SLLogicalAndNode create(SourceSection src, SLExpressionNode leftNode, SLExpressionNode rightNode) {
        return new SLLogicalAndNodeGen(src, leftNode, rightNode);
    }
