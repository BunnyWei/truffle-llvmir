...
public final class SLMulNodeGen extends SLMulNode implements SpecializedNode {
    ...
    private SLMulNodeGen(SourceSection src, SLExpressionNode leftNode, SLExpressionNode rightNode) {
        super(src);
    ...
    public static SLMulNode create(SourceSection src, SLExpressionNode leftNode, SLExpressionNode rightNode) {
        return new SLMulNodeGen(src, leftNode, rightNode);
    }

    @GeneratedBy(SLMulNode.class)
    private abstract static class BaseNode_ extends SLTypesNode {

        protected final SLMulNodeGen root;

        BaseNode_(SLMulNodeGen root, int index) {
            super(index);
            this.root = root;
        }
    ...
    private static final class UninitializedNode_ extends BaseNode_ {
        ...
        UninitializedNode_(SLMulNodeGen root) {
        ...
        static BaseNode_ create(SLMulNodeGen root) {
    ...
    private static final class PolymorphicNode_ extends BaseNode_ {
        ...
        PolymorphicNode_(SLMulNodeGen root) {
            super(root, 0);
        }
    ...
    @GeneratedBy(methodName = "mul(long, long)", value = SLMulNode.class)
    private static final class Mul0Node_ extends BaseNode_ {

        Mul0Node_(SLMulNodeGen root) {
            super(root, 1);
        }
    ...
    @GeneratedBy(methodName = "mul(BigInteger, BigInteger)", value = SLMulNode.class)
    private static final class Mul1Node_ extends BaseNode_ {
        ...
        Mul1Node_(SLMulNodeGen root, Object leftNodeValue, Object rightNodeValue) {
            super(root, 2);
        ...
        static BaseNode_ create(SLMulNodeGen root, Object leftNodeValue, Object rightNodeValue) {
