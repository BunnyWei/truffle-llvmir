...
public final class SLSubNodeGen extends SLSubNode implements SpecializedNode {
    ...
    private SLSubNodeGen(SourceSection src, SLExpressionNode leftNode, SLExpressionNode rightNode) {
        super(src);
    ...
    public static SLSubNode create(SourceSection src, SLExpressionNode leftNode, SLExpressionNode rightNode) {
        return new SLSubNodeGen(src, leftNode, rightNode);
    }

    @GeneratedBy(SLSubNode.class)
    private abstract static class BaseNode_ extends SLTypesNode {

        protected final SLSubNodeGen root;

        BaseNode_(SLSubNodeGen root, int index) {
            super(index);
            this.root = root;
        }
    ...
    private static final class UninitializedNode_ extends BaseNode_ {
        ...
        UninitializedNode_(SLSubNodeGen root) {
        ...
        static BaseNode_ create(SLSubNodeGen root) {
    ...
    private static final class PolymorphicNode_ extends BaseNode_ {
        ...
        PolymorphicNode_(SLSubNodeGen root) {
            super(root, 0);
        }
    ...
    @GeneratedBy(methodName = "sub(long, long)", value = SLSubNode.class)
    private static final class Sub0Node_ extends BaseNode_ {

        Sub0Node_(SLSubNodeGen root) {
            super(root, 1);
        }
    ...
    @GeneratedBy(methodName = "sub(BigInteger, BigInteger)", value = SLSubNode.class)
    private static final class Sub1Node_ extends BaseNode_ {
        ...
        Sub1Node_(SLSubNodeGen root, Object leftNodeValue, Object rightNodeValue) {
            super(root, 2);
        ...
        static BaseNode_ create(SLSubNodeGen root, Object leftNodeValue, Object rightNodeValue) {
