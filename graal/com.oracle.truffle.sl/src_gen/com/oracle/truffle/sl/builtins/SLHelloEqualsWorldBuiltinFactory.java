...
public final class SLHelloEqualsWorldBuiltinFactory extends NodeFactoryBase<SLHelloEqualsWorldBuiltin> {

    private static SLHelloEqualsWorldBuiltinFactory instance;

    private SLHelloEqualsWorldBuiltinFactory() {
        super(SLHelloEqualsWorldBuiltin.class, DSLMetadata.EMPTY_CLASS_ARRAY, new Class<?>[][] {new Class<?>[] {SLExpressionNode[].class, SLContext.class}});
    }
